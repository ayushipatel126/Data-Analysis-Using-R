data_US <- read.csv("E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/asylum_seekers.csv")
...
write.csv(Applied_data_US,"E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outApplieddataUS.csv", row.names = FALSE)
write.csv(Rejected_data_US,"E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outRejecteddataUS.csv", row.names = FALSE)
