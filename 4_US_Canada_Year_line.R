...
write.csv(final_data,"E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outputUNdata.csv", row.names = FALSE)
...
data_read <- read.csv("E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outputUNdata.csv")
