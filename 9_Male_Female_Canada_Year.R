data_canada <- read.csv("E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/demographics.csv")
retrival_data_canada <- unique(subset(data_canada, Country=="Canada",select=c("Year","Country","FTotal","MTotal")))
write.csv(retrival_data_canada,"E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outputdemographics.csv", row.names = FALSE)
