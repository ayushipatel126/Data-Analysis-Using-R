data_canada <- read.csv("E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/asylum_seekers.csv")
...
write.csv(Applied_data_canada,"E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outApplieddatacanada.csv", row.names = FALSE)
write.csv(Rejected_data_canada,"E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outRejecteddatacanada.csv", row.names = FALSE)
