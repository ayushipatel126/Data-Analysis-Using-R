data <- read.csv("E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/UNdata_Export_20180512_213810165.csv")
...
write.csv(final_data,"E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outputUNdataBar.csv", row.names = FALSE)
...
data_read <- read.csv("E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outputUNdataBar.csv")
