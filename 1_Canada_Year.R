data_canada <- read.csv("E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/UNdata_Export_20180512_213810165.csv")
...
write.csv(final_data_canada,"E:/Masters/Sem 2/Advanced Database Topics/Project 1 Data Analysis/Refugee/outputUNdata2.csv", row.names = FALSE)
